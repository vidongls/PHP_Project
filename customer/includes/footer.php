        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-md-3">
                ...
                <ul>
                    ...
                    <li><a href="customer/my_account.php">Tài khoàn</a></li>
                </ul><!-- ul Finish -->
            ...
            <div class="col-sm-6 col-md-3">
                ...
                <p>
                    <!-- p Start -->
                    <strong>DongVi cutee</strong>
                    <br />0399999362
                    <br />vidongls12345@gmail.com
...
<div id="copyright">
    ...
    <div class="container">
        ...
        <div class="col-md-6">
            ...
            <p class="pull-left">&copy; 2021 DongVi All Rights Reserve</p>

        </div><!-- col-md-6 Finish -->
        <div class="col-md-6">
            <!-- col-md-6 Begin -->

            <p class="pull-right">Theme by: <a href="#">Dongvi</a></p>
