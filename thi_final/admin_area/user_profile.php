    ...
    <div class="col-lg-12"><!-- col-lg-12 Begin -->
        ...
        <ol class="breadcrumb"><!-- breadcrumb Begin -->
            ...
            <li class="active" style="text-transform:uppercase;"><!-- active Begin -->
                ...
                <i class="fa fa-dashboard"></i> Bảng điều khiển / sửa thông tin
        ...
        <div class="panel panel-default"><!-- panel panel-default Begin -->
           ...
           <div class="panel-heading"><!-- panel-heading Begin -->
               ...
               <h3 class="panel-title" style="text-transform:uppercase;"><!-- panel-title Begin -->
                   ...
                   <i class="fa fa-money fa-fw"></i> sửa thông tin
...
if(isset($_POST['update'])){
    ...
    $update_user = "update admins set admin_name='$user_name',admin_email='$user_email',admin_pass='$user_pass',admin_contact='$user_contact',admin_image='$user_image' where admin_id='$user_id'";
